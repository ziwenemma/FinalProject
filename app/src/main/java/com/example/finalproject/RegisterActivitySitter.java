...
public class RegisterActivitySitter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                fAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(RegisterActivitySitter.this, "Babysitter account Created", Toast.LENGTH_LONG).show();
                            FirebaseUser fuser = fAuth.getCurrentUser();
                            fuser.sendEmailVerification().addOnSuccessListener(new OnSuccessListener<Void>() {

                                @Override
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(RegisterActivitySitter.this, "Verification Email Has been Sent.", Toast.LENGTH_SHORT).show();
                                }
                            ...
                            Toast.makeText(RegisterActivitySitter.this, "Error!" + task.getException().getMessage(), Toast.LENGTH_LONG).show();
                        }
                    }
                });
            }
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), LoginActivitySitter.class));
            }
        });
    }
}
