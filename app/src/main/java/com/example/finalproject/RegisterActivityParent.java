...
public class RegisterActivityParent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                fAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(RegisterActivityParent.this, "Parent User Created", Toast.LENGTH_LONG).show();
                            FirebaseUser fuser = fAuth.getCurrentUser();
                            fuser.sendEmailVerification().addOnSuccessListener(new OnSuccessListener<Void>() {

                                @Override
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(RegisterActivityParent.this, "Verification Email Has been Sent.", Toast.LENGTH_SHORT).show();
                                }
                            ...
                            Toast.makeText(RegisterActivityParent.this, "Error!" + task.getException().getMessage(), Toast.LENGTH_LONG).show();
                        }
                    }
                });
            }
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), LoginActivityParent.class));
            }
        });
    }
}
